    ...
    <>
      ...
      {(snap.intro === 2 || window.location.pathname === `/booth/format/${machineId}`) && isVisible && (
          <div className="w-screen h-screen flex flex-col justify-between border-transparent ">
            ...
            {/* Main Content */}
            <div
              className="w-full h-full flex justify-center items-center gap-2 sm:gap-[3rem] md:gap-[5rem] lg:gap-[2rem] xl:gap-[10rem] 2xl:gap-[20rem] border-2 border-transparent pb-[4rem]  select-none"
            >
                {/* Format 1 */}
                <div>
                <motion.div className="xl:w-[29.06rem] xl:h-[41.19rem] lg:w-[25rem] lg:h-[37.13rem] md:w-[17rem] md:h-[29.13rem] sm:w-[15rem] sm:h-[24.13rem] w-[12rem] h-[24.13rem] border-2 border-transparent cursor-pointer flex justify-end items-end"
                  ...
                  >
                    ...
                    <motion.div className="xl:w-[26.13rem] xl:h-[39.2rem] lg:w-[22.07rem] lg:h-[35.14rem] md:w-[14.07rem] md:h-[27.14rem] sm:h-[22.14rem] sm:w-[12.5rem] h-[22.14rem] w-[10.57rem] border-2 border-[#C7C7CC] bg-[#C7C7CC] absolute z-10"
                      ...
                      >
                        <div className="w-full xl:h-[17rem] lg:h-[13rem] md:h-[9rem] sm:h-[8rem] h-[7rem] border-2 border-transparent flex  gap-2 sm:gap-3 lg:gap-4 justify-center items-center">
                            ...
                            <div className="xl:w-[11.5rem] xl:h-[15.44rem] lg:w-[9.44rem] lg:h-[11.38rem] md:w-[6rem] md:h-[8rem] sm:w-[5rem] sm:h-[7rem] w-[4.5rem] h-[6rem] font-inter-400 text-sm md:text-base text-[#666666] bg-white flex flex-col justify-end items-center pb-3">
                                <p>{getText("Photo", "รูปภาพ")}</p>
                                <p>{getText("Size 3 X 4", "ขนาด 3 X 4")}</p>
                            </div>
                        </div>
                        <div className="w-full xl:h-[17rem] lg:h-[13rem] md:h-[9rem] sm:h-[8rem] border-2 border-transparent flex gap-2 sm:gap-3 lg:gap-4 justify-center items-center lg:mt-[-0.5rem]">
                            ...
                            <div className="xl:w-[11.5rem] xl:h-[15.44rem] lg:w-[9.44rem] lg:h-[11.38rem] md:w-[6rem] md:h-[8rem] sm:w-[5rem] sm:h-[7rem] w-[4.5rem] h-[6rem] bg-[#C7C7CC]">
                        ...
                        <div className="w-full xl:h-[5.5rem] border-2 border-transparent flex gap-4 justify-center items-center xl:mt-0 lg:mt-[5.7rem] md:mt-[5.2rem] sm:mt-[2.7rem] mt-[5.4rem]">
                            <div className="xl:w-[11.5rem] lg:w-[9.44rem]  md:w-[6rem] sm:w-[5rem] w-[4.5rem] h-full bg-transparent font-inter-400 text-base text-white flex flex-col justify-end items-start text-center">
                                ...
                                <p>{getText("Frame A", "เฟรม A")}</p>
                                <p>{getText("Size 4 X 6", "ขนาด 4 X 6")}</p>
                                </div>
                            </div>
                            <div className="xl:w-[11.5rem] lg:w-[9.44rem]  md:w-[6rem] sm:w-[5rem] w-[4.5rem] h-full bg-[#C7C7CC]">
                ...
                <div className="xl:w-[29.06rem] lg:w-[25rem] md:w-[17rem] sm:w-[15rem] w-[12rem] h-[7rem] border-2 border-transparent font-bebas-neue-400 flex justify-center items-center text-[2rem] absolute">
                  <motion.div className="w-[18rem] h-[5rem] border-[1px] flex justify-center items-center"
                ...
                {/* Format 2 */}
                <div>
                <motion.div className="xl:w-[39.2rem] xl:h-[40.2rem] lg:w-[35rem] lg:h-[35rem] md:w-[25rem] md:h-[30rem] sm:w-[19rem] sm:h-[24rem] w-[16rem] h-[24rem] border-2 border-transparent cursor-pointer flex items-center"
                   initial={{ scale: 0 }}
                   animate={{
                 ...
                 >
                  ...
                  <motion.div className="xl:w-[26.13rem] xl:h-[39.2rem] lg:w-[22.07rem] lg:h-[35.14rem] md:w-[14.07rem] md:h-[27.14rem] sm:h-[22.14rem] sm:w-[12.5rem] h-[19.14rem] w-[10.57rem] ml-12 border-2 border-[#C7C7CC] bg-[#C7C7CC] absolute z-10 "
                   whileHover={{ scale: 1.1 }}
                   whileTap={{ scale: 0.9 }}
                  ...
                  >
                        ...
                        <div className="xl:w-[11.5rem] xl:h-[7rem] lg:w-[9.44rem] lg:h-[6rem] md:w-[6rem] md:h-[4.5rem] sm:w-[5rem] sm:h-[3.5rem] w-[4.5rem] h-[3.5rem] bg-white font-inter-400 text-[0.6rem] md:text-sm lg:text-base text-[#666666] flex items-center justify-center relative">
                            <p className="absolute md:left-[-1.2rem] left-[-1rem] "style={{ transform: 'rotate(90deg)' }}>{getText("Size 2 X 3", "ขนาด 2 X 3")}</p>
                            <p className="absolute md:left-4 left-2 "style={{ transform: 'rotate(90deg)' }}>{getText("Photo", "รูปภาพ")}</p>
                        </div>
                            <div className="xl:w-[11.5rem] xl:h-[7rem] lg:w-[9.44rem] lg:h-[6rem] md:w-[6rem] md:h-[4.5rem] sm:w-[5rem] sm:h-[3.5rem] w-[4.5rem] h-[3.5rem] bg-white">
                ...
                <div className="xl:w-[39.2rem] lg:w-[35rem] md:w-[25rem] sm:w-[19rem] w-[16rem] h-[7rem] border-2 border-transparent font-bebas-neue-400 flex justify-center items-center text-[2rem] absolute">
                  <motion.div className="w-[18rem] h-[5rem] border-[1px] flex justify-center items-center"
                   initial={{ scale: 0, opacity: 0 }} 
                   animate={{ scale: 1, opacity: 1 }} 
                   transition={{
