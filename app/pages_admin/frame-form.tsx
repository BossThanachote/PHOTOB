    ...
    <div className="min-h-screen bg-[#F7F7F7] select-none">
      ...
      <div className="p-6 h-[calc(100vh-4rem)]">
        <div className="bg-white rounded-lg shadow-sm h-[53rem]">
          ...
          {/* Table */}
          <div className="px-6 flex flex-col flex-grow h-[44rem]">
          <div className="flex-grow">
          <table className="w-full">
            <thead>
              <tr className="border-y">
                <th className="py-4 px-10 text-left font-medium">
            ...
            <tbody>
              {frames.map((frame) => (
                <tr key={frame.no} className="border-b">
                  <td className="py-4 px-11">{frame.no}</td>
                  ...
                  <td className="py-4 px-4">
                    ...
                    {openDropdownId === frame.no && (
                      <div className="absolute mt-1 w-[120px] bg-white border rounded-md shadow-lg">
                        <button
                          type="button"
