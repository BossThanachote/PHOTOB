...
import { Frame, Sticker, StatusType } from '@/types/types'
...
export default function AddMachine() {
  ...
  const [availableFrames, setAvailableFrames] = useState<Frame[]>(frameAPI.getFrames());
  const [availableStickers, setAvailableStickers] = useState<Sticker[]>(stickerAPI.getStickers());
  ...
  const handleSubmit = () => {
    try {
      ...
      if (formData.type === 'Event') {
        eventAPI.addTransaction(newMachineData);
        router.push('/admin/machine/event');
      } else {
        departmentAPI.addTransaction(newMachineData);
          ...
          <div className="min-h-screen bg-[#F7F7F7]">
            ...
            <div className="h-[4rem] bg-white flex justify-between items-center px-6 shadow-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#8E8E93]">Add New Machine</span>
              </div>
              <button
                type="button"
              ...
              <div className="bg-white rounded-lg shadow-sm">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-6">
                    Add new machine information and configuration.
                  </p>
